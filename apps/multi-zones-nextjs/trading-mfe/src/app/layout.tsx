...
export const metadata: Metadata = {
    title: "Trading MFE: Fintech App",
    description: "A micro-frontend representing the Trading page in the fintech platform. Follows Next.js Multi-Zones Micro-frontend Architecture.",
};
