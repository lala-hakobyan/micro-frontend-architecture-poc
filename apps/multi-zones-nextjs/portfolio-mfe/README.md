# Portfolio MFE: Fintech App Starter Project
...
- Standalone: [http://localhost:5002/portfolio](http://localhost:5002/portfolio)
- Via shell (if shell is running): [http://localhost:5000/portfolio](http://localhost:5000/portfolio)
...
- Standalone: [https://portfolio.local-fintech.com:5002/portfolio](https://portfolio.local-fintech.com:5002/portfolio)
- Via shell (if shell is running): [https://shell.local-fintech.com:5000/portfolio](https://shell.local-fintech.com:5000/portfolio)
